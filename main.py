...
# --- AUTOMATIC DSN FIX ---
# This resolves the 'psycopg2.ProgrammingError' from your logs
...
def sync_categories():
    ...
    while has_more:
        ...
        if not entities:
            ...
            # 4over API uses 'total_pages' for pagination control
...
def sync_postcards_full():
    ...
    # Locate Postcard category in our freshly synced DB
    ...
    for prod in products:
        ...
        # Fetch every detail including Runsize (Quantity)
